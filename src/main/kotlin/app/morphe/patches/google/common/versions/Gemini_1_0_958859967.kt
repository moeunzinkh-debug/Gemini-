...
/**
 * Gemini launcher 1.0.958859967 - verified hook targets.
 *
 * The launcher is a shell: the Gemini ("Robin") UI is hosted by the Google app, which is why the
 * redirect below points at the cloned Google package instead of the Play Store one.
 */
val gemini10958859967 = AppVersionProfile(
    ...
    validation = listOf(
        "2026-09-06: launcher used with verified Google 17.54.18; regenerated DEX matches working build (upstream)",
