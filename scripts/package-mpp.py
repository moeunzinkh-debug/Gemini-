...
expected_url = f'https://github.com/moeunzinkh-debug/Gemini-/releases/download/v{version}/{name}'
...
attributes = {
    ...
    'Name': 'Gemini standalone patches',
    'Description': 'Gemini with microG: no Play Store Google app required',
    'Version': version,
    'Timestamp': str(timestamp),
    'Source': 'https://github.com/moeunzinkh-debug/Gemini-',
    'Author': 'moeunzinkh-debug',
    'Website': 'https://github.com/moeunzinkh-debug/Gemini-',
